"""Visualize multi-resolution outputs."""
...
from wildfire.vis.plots import plot_multi_resolution
...
def main() -> None:
    ...
    out_path = Path(args.artifacts_dir) / "reports" / "plots" / "multi_resolution.png"
    ...
    LOGGER.info("Saved multi-resolution plot to %s", out_path)
